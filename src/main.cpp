...
int main(int argc, char*argv[]) {
    ...
    try {
        ...
        fprintf(stderr, "An error occurred while initializing the renderer: %s. See https://www.craftos-pc.cc/docs/error-messages for more info. CraftOS-PC will now close.\n", e.what());
        SDL_Quit();
        return 2;
    }
    driveInit();
