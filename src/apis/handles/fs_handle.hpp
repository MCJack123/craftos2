...
extern int fs_handle_readAllUTF(lua_State *L);
extern int fs_handle_readLineUTF(lua_State *L);
extern int fs_handle_readCharUTF(lua_State *L);
...
extern int fs_handle_istream_readAllUTF(lua_State *L);
extern int fs_handle_istream_readLineUTF(lua_State *L);
extern int fs_handle_istream_readCharUTF(lua_State *L);
