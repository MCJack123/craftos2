...
#endif
    fprintf(stderr, "Uh oh, CraftOS-PC has crashed! Reason: %s (%d). Please report this to https://github.com/MCJack123/craftos2/issues/new/choose. Paste the following text under the 'Screenshots' section:\n", strsignal(sig_num), sig_num);
